...
export type RecursivePartialNull<T> = MovedRecursivePartialNull<T>
    ...
    env?: Record<string, string | undefined>
      tags?: Record<string, string>
        ...
        __baml_options__?: BamlCallOptions<never>
        ): Promise<types.ValidationAnalysisResponse> {
          try {
          ...
          const __stream__ = this.stream.AnalyzeValidationResults(
          testCases,testResults,stats,
          __baml_options__
          );
          ...
          const __env__: Record<string, string> = Object.fromEntries(
            ...
            return __raw__.parsed(false) as types.ValidationAnalysisResponse
            } catch (error) {
        ...
        __baml_options__?: BamlCallOptions<never>
        ): Promise<types.ManifestsResponse> {
          try {
          const __options__ = { ...this.bamlOptions, ...(__baml_options__ || {}) }
          const __signal__ = __options__.signal;
          ...
          // Check if onTick is provided - route through streaming if so
          if (__options__.onTick) {
          const __stream__ = this.stream.GenerateKubernetesManifests(
          graph,nodes,rag_context,user_context,k8s_version,
          __baml_options__
          );
          ...
          const __env__: Record<string, string> = Object.fromEntries(
            ...
            return __raw__.parsed(false) as types.ManifestsResponse
            } catch (error) {
            throw toBamlError(error);
            }
            }
            
        async GenerateValidationTestCases(
        paths: types.OpenApiPathEntry[],
        __baml_options__?: BamlCallOptions<never>
        ): Promise<types.ValidationTestCasesResponse> {
          try {
          const __options__ = { ...this.bamlOptions, ...(__baml_options__ || {}) }
          const __signal__ = __options__.signal;
          ...
          // Check if onTick is provided - route through streaming if so
          if (__options__.onTick) {
          const __stream__ = this.stream.GenerateValidationTestCases(
          paths,
          __baml_options__
          );
          ...
          const __env__: Record<string, string> = Object.fromEntries(
            ...
            return __raw__.parsed(false) as types.ValidationTestCasesResponse
            } catch (error) {
            throw toBamlError(error);
            }
            }
            
        async SanitizeUserContext(
        messages: string[],
        __baml_options__?: BamlCallOptions<never>
        ): Promise<string[]> {
          try {
          ...
          // Check if onTick is provided - route through streaming if so
          if (__options__.onTick) {
          const __stream__ = this.stream.SanitizeUserContext(
          messages,
          __baml_options__
          );
          ...
          const __env__: Record<string, string> = Object.fromEntries(
            ...
            testCases: types.TestCaseSummary[],testResults: types.TestResultSummary[],stats: types.ValidationStats,
            __baml_options__?: BamlCallOptions<never>
            ): BamlStream<partial_types.ValidationAnalysisResponse, types.ValidationAnalysisResponse>
              {
              try {
              const __options__ = { ...this.bamlOptions, ...(__baml_options__ || {}) }
              const __signal__ = __options__.signal;
              ...
              console.error("Error in onTick callback for AnalyzeValidationResults", error);
              }
              }
              };
              }
              ...
              const __env__: Record<string, string> = Object.fromEntries(
                ...
                return new BamlStream<partial_types.ValidationAnalysisResponse, types.ValidationAnalysisResponse>(
                  __raw__,
                  (a): partial_types.ValidationAnalysisResponse => a,
                  (a): types.ValidationAnalysisResponse => a,
                  this.ctxManager.cloneContext(),
                  __options__.signal,
                  )
                  } catch (error) {
            ...
            graph: types.GraphContext,nodes: types.NodeContext[],rag_context: types.RAGContextInput,user_context: types.UserContextInput,k8s_version: string,
            __baml_options__?: BamlCallOptions<never>
            ): BamlStream<partial_types.ManifestsResponse, types.ManifestsResponse>
              {
              try {
              const __options__ = { ...this.bamlOptions, ...(__baml_options__ || {}) }
              const __signal__ = __options__.signal;
              ...
              console.error("Error in onTick callback for GenerateKubernetesManifests", error);
              }
              }
              };
              }
              ...
              const __env__: Record<string, string> = Object.fromEntries(
                ...
                return new BamlStream<partial_types.ManifestsResponse, types.ManifestsResponse>(
                  __raw__,
                  (a): partial_types.ManifestsResponse => a,
                  (a): types.ManifestsResponse => a,
                  this.ctxManager.cloneContext(),
                  __options__.signal,
                  )
                  } catch (error) {
            ...
            paths: types.OpenApiPathEntry[],
            __baml_options__?: BamlCallOptions<never>
            ): BamlStream<partial_types.ValidationTestCasesResponse, types.ValidationTestCasesResponse>
              {
              try {
              const __options__ = { ...this.bamlOptions, ...(__baml_options__ || {}) }
              const __signal__ = __options__.signal;
              ...
              console.error("Error in onTick callback for GenerateValidationTestCases", error);
              }
              }
              };
              }
              ...
              const __env__: Record<string, string> = Object.fromEntries(
                ...
                return new BamlStream<partial_types.ValidationTestCasesResponse, types.ValidationTestCasesResponse>(
                  __raw__,
                  (a): partial_types.ValidationTestCasesResponse => a,
                  (a): types.ValidationTestCasesResponse => a,
                  this.ctxManager.cloneContext(),
                  __options__.signal,
                  )
                  } catch (error) {
            ...
            __baml_options__?: BamlCallOptions<never>
              ...
              console.error("Error in onTick callback for SanitizeUserContext", error);
              }
              }
              };
              }
