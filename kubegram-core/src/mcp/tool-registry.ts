...
/**
 * Interface passed to every tool handler.
 * Add fields here as tools need access to more service capabilities.
 * Defined here (not in service.ts) to avoid circular imports.
 */
export interface MCPToolServiceContext {
  codegenWorkflow?: CodegenWorkflow;
  planWorkflow?: PlanWorkflow;
  /** Caller-supplied implementation for graph persistence and RAG context. */
  ...
  // Codegen tools
  {
    ...
    inputSchema: {
      ...
      properties: {
        graphId: {
          type: "string",
          description: "Existing graph ID (optional if nodes provided)",
        },
        ...
        customInstructions: {
          type: "string",
          description: "Custom instructions for code generation",
        },
      },
    },
    ...
    inputSchema: {
      ...
      properties: {
        userRequest: {
          type: "string",
          description:
            "Natural language description of the infrastructure needed",
        },
        namespace: { type: "string", description: "Kubernetes namespace" },
        existingGraphId: {
          type: "string",
          description: "Optional existing graph to modify",
        },
        modelProvider: { type: "string", description: "LLM provider" },
        customContext: {
          type: "array",
          items: { type: "string" },
          description: "Custom context messages",
        },
      },
  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        includeBridges: {
          type: "boolean",
          description: "Include bridge details",
        },
      },
      required: ["graphId"],
    },
  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        graphType: {
          type: "string",
          description: "Graph type (KUBERNETES, INFRASTRUCTURE, etc.)",
        },
  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        limit: {
          type: "number",
          description: "Number of similar graphs to retrieve",
        },
      },
      required: ["graphId"],
    },
