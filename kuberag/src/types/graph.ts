 ...
 * These interfaces are used throughout the application - no dual model layer
 * Source: kuberag-old/api/graphql/schema.graphql
 */

import { GraphNodeType, DependencyType, GraphType, ConnectionType, KubernetesClusterType } from './enums';
...
// Resource Input Types (simplified versions for mutations)
