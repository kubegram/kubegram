...
export const GetMicroservicesDocument = gql`
  ...
  microservices(companyId: $companyId) {
    ...
    `;
export const GetMicroserviceDocument = gql`
  ...
  microservice(id: $id) {
    ...
    `;
export const GetExternalDependenciesDocument = gql`
...
export const GetNodesDocument = gql`
  ...
  nodes(graphId: $graphId) {
    ...
    `;
export const CreateMicroserviceDocument = gql`
  ...
  createMicroservice(input: $input) {
    ...
    `;
export const UpdateMicroserviceDocument = gql`
  ...
  updateMicroservice(input: $input) {
    ...
    `;
export const DeleteMicroserviceDocument = gql`
...
export const CreateGraphDocument = gql`
  ...
  createGraph(input: $input) {
    ...
    `;
export const GetConnectionTypeDocument = gql`
  ...
  connectionType(
    ...
    `;
export const GenerateCodeDocument = gql`
  ...
  generatedCode(jobId: $jobId) {
    ...
    `;
export const ValidateConnectionDocument = gql`
...
export const GetSuggestionDocument = gql`
  ...
  getSuggestion(sourceId: $sourceId, sourceType: $sourceType) {
    ...
    `;
export const CreateKubernetesClusterDocument = gql`
  ...
  createKubernetesCluster(input: $input) {
    ...
    `;
export const CreateKubernetesGraphDocument = gql`
...
export const DeleteGraphDocument = gql`
  ...
  deleteGraph(id: $id, companyId: $companyId, userId: $userId)
    ...
    `;
export const DeleteKubernetesClusterDocument = gql`
  ...
  deleteKubernetesCluster(id: $id, companyId: $companyId, userId: $userId)
    ...
    `;
export const DeleteKubernetesGraphDocument = gql`
...
export const UpdateGraphDocument = gql`
  ...
  updateGraph(id: $id, input: $input) {
    ...
    `;
export const UpdateKubernetesClusterDocument = gql`
  ...
  updateKubernetesCluster(input: $input) {
    ...
    `;
export const UpdateKubernetesGraphDocument = gql`
  ...
  updateKubernetesGraph(input: $input) {
    ...
    `;
export const DeployInfrastructureDocument = gql`
  ...
  deployInfrastructure(input: $input) {
    ...
    `;
export const InitializeCodeGenDocument = gql`
  ...
  initializeCodeGen(input: $input) {
    ...
    `;
export const ExternalDependencyDocument = gql`
...
export const GraphDocument = gql`
  ...
  graph(id: $id, companyId: $companyId, userId: $userId) {
    ...
    `;
export const GraphByNameDocument = gql`
  ...
  graphByName(name: $name, companyId: $companyId) {
    ...
    `;
export const KubernetesClusterDocument = gql`
...
export const KubernetesClustersDocument = gql`
  ...
  kubernetesClusters(companyId: $companyId) {
    ...
    `;
export const KubernetesGraphDocument = gql`
  ...
  kubernetesGraph(id: $id) {
    ...
    `;
export const KubernetesGraphsDocument = gql`
  ...
  kubernetesGraphs(companyId: $companyId) {
    ...
    `;
export const KubernetesResourcesByNamespaceDocument = gql`
  ...
  kubernetesResourcesByNamespace(companyId: $companyId, namespace: $namespace) {
    ...
    `;
export const KubernetesResourcesByTypeDocument = gql`
...
export const JobStatusDocument = gql`
  ...
  jobStatus(input: $input) {
    ...
    `;
export const InitializePlanDocument = gql`
...
const GetMicroservicesDocumentString = print(GetMicroservicesDocument);
const GetMicroserviceDocumentString = print(GetMicroserviceDocument);
const GetExternalDependenciesDocumentString = print(GetExternalDependenciesDocument);
const GetGraphsDocumentString = print(GetGraphsDocument);
const GetNodesDocumentString = print(GetNodesDocument);
const CreateMicroserviceDocumentString = print(CreateMicroserviceDocument);
const UpdateMicroserviceDocumentString = print(UpdateMicroserviceDocument);
const DeleteMicroserviceDocumentString = print(DeleteMicroserviceDocument);
const CreateGraphDocumentString = print(CreateGraphDocument);
const GetConnectionTypeDocumentString = print(GetConnectionTypeDocument);
const GenerateCodeDocumentString = print(GenerateCodeDocument);
const ValidateConnectionDocumentString = print(ValidateConnectionDocument);
const ValidateGraphDocumentString = print(ValidateGraphDocument);
const GetSuggestionDocumentString = print(GetSuggestionDocument);
const CreateKubernetesClusterDocumentString = print(CreateKubernetesClusterDocument);
const CreateKubernetesGraphDocumentString = print(CreateKubernetesGraphDocument);
const DeleteGraphDocumentString = print(DeleteGraphDocument);
const DeleteKubernetesClusterDocumentString = print(DeleteKubernetesClusterDocument);
const DeleteKubernetesGraphDocumentString = print(DeleteKubernetesGraphDocument);
const UpdateGraphDocumentString = print(UpdateGraphDocument);
const UpdateKubernetesClusterDocumentString = print(UpdateKubernetesClusterDocument);
const UpdateKubernetesGraphDocumentString = print(UpdateKubernetesGraphDocument);
const DeployInfrastructureDocumentString = print(DeployInfrastructureDocument);
const InitializeCodeGenDocumentString = print(InitializeCodeGenDocument);
const ExternalDependencyDocumentString = print(ExternalDependencyDocument);
const GraphDocumentString = print(GraphDocument);
const GraphByNameDocumentString = print(GraphByNameDocument);
const KubernetesClusterDocumentString = print(KubernetesClusterDocument);
const KubernetesClustersDocumentString = print(KubernetesClustersDocument);
const KubernetesGraphDocumentString = print(KubernetesGraphDocument);
const KubernetesGraphsDocumentString = print(KubernetesGraphsDocument);
const KubernetesResourcesByNamespaceDocumentString = print(KubernetesResourcesByNamespaceDocument);
const KubernetesResourcesByTypeDocumentString = print(KubernetesResourcesByTypeDocument);
const NodeDocumentString = print(NodeDocument);
const JobStatusDocumentString = print(JobStatusDocument);
const InitializePlanDocumentString = print(InitializePlanDocument);
const GetPlanDocumentString = print(GetPlanDocument);
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    GetMicroservices(variables: GetMicroservicesQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<{ data: GetMicroservicesQuery; errors?: GraphQLError[]; extensions?: any; headers: Headers; status: number; }> {
        return withWrapper((wrappedRequestHeaders) => client.rawRequest<GetMicroservicesQuery>(GetMicroservicesDocumentString, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'GetMicroservices', 'query', variables);
    },
    GetMicroservice(variables: GetMicroserviceQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<{ data: GetMicroserviceQuery; errors?: GraphQLError[]; extensions?: any; headers: Headers; status: number; }> {
        return withWrapper((wrappedRequestHeaders) => client.rawRequest<GetMicroserviceQuery>(GetMicroserviceDocumentString, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'GetMicroservice', 'query', variables);
    },
    GetExternalDependencies(variables: GetExternalDependenciesQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<{ data: GetExternalDependenciesQuery; errors?: GraphQLError[]; extensions?: any; headers: Headers; status: number; }> {
        return withWrapper((wrappedRequestHeaders) => client.rawRequest<GetExternalDependenciesQuery>(GetExternalDependenciesDocumentString, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'GetExternalDependencies', 'query', variables);
    },
    GetGraphs(variables: GetGraphsQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<{ data: GetGraphsQuery; errors?: GraphQLError[]; extensions?: any; headers: Headers; status: number; }> {
        return withWrapper((wrappedRequestHeaders) => client.rawRequest<GetGraphsQuery>(GetGraphsDocumentString, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'GetGraphs', 'query', variables);
    },
    GetNodes(variables: GetNodesQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<{ data: GetNodesQuery; errors?: GraphQLError[]; extensions?: any; headers: Headers; status: number; }> {
        return withWrapper((wrappedRequestHeaders) => client.rawRequest<GetNodesQuery>(GetNodesDocumentString, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'GetNodes', 'query', variables);
    },
    CreateMicroservice(variables: CreateMicroserviceMutationVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<{ data: CreateMicroserviceMutation; errors?: GraphQLError[]; extensions?: any; headers: Headers; status: number; }> {
        return withWrapper((wrappedRequestHeaders) => client.rawRequest<CreateMicroserviceMutation>(CreateMicroserviceDocumentString, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'CreateMicroservice', 'mutation', variables);
    },
    UpdateMicroservice(variables: UpdateMicroserviceMutationVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<{ data: UpdateMicroserviceMutation; errors?: GraphQLError[]; extensions?: any; headers: Headers; status: number; }> {
        return withWrapper((wrappedRequestHeaders) => client.rawRequest<UpdateMicroserviceMutation>(UpdateMicroserviceDocumentString, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'UpdateMicroservice', 'mutation', variables);
    },
    DeleteMicroservice(variables: DeleteMicroserviceMutationVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<{ data: DeleteMicroserviceMutation; errors?: GraphQLError[]; extensions?: any; headers: Headers; status: number; }> {
        return withWrapper((wrappedRequestHeaders) => client.rawRequest<DeleteMicroserviceMutation>(DeleteMicroserviceDocumentString, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'DeleteMicroservice', 'mutation', variables);
    },
    CreateGraph(variables: CreateGraphMutationVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<{ data: CreateGraphMutation; errors?: GraphQLError[]; extensions?: any; headers: Headers; status: number; }> {
        return withWrapper((wrappedRequestHeaders) => client.rawRequest<CreateGraphMutation>(CreateGraphDocumentString, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'CreateGraph', 'mutation', variables);
    },
    GetConnectionType(variables: GetConnectionTypeQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<{ data: GetConnectionTypeQuery; errors?: GraphQLError[]; extensions?: any; headers: Headers; status: number; }> {
        return withWrapper((wrappedRequestHeaders) => client.rawRequest<GetConnectionTypeQuery>(GetConnectionTypeDocumentString, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'GetConnectionType', 'query', variables);
    },
    GenerateCode(variables: GenerateCodeQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<{ data: GenerateCodeQuery; errors?: GraphQLError[]; extensions?: any; headers: Headers; status: number; }> {
        return withWrapper((wrappedRequestHeaders) => client.rawRequest<GenerateCodeQuery>(GenerateCodeDocumentString, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'GenerateCode', 'query', variables);
    },
    ValidateConnection(variables: ValidateConnectionQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<{ data: ValidateConnectionQuery; errors?: GraphQLError[]; extensions?: any; headers: Headers; status: number; }> {
        return withWrapper((wrappedRequestHeaders) => client.rawRequest<ValidateConnectionQuery>(ValidateConnectionDocumentString, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'ValidateConnection', 'query', variables);
    },
    ValidateGraph(variables: ValidateGraphQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<{ data: ValidateGraphQuery; errors?: GraphQLError[]; extensions?: any; headers: Headers; status: number; }> {
        return withWrapper((wrappedRequestHeaders) => client.rawRequest<ValidateGraphQuery>(ValidateGraphDocumentString, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'ValidateGraph', 'query', variables);
    },
    GetSuggestion(variables: GetSuggestionQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<{ data: GetSuggestionQuery; errors?: GraphQLError[]; extensions?: any; headers: Headers; status: number; }> {
        return withWrapper((wrappedRequestHeaders) => client.rawRequest<GetSuggestionQuery>(GetSuggestionDocumentString, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'GetSuggestion', 'query', variables);
    },
    CreateKubernetesCluster(variables: CreateKubernetesClusterMutationVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<{ data: CreateKubernetesClusterMutation; errors?: GraphQLError[]; extensions?: any; headers: Headers; status: number; }> {
        return withWrapper((wrappedRequestHeaders) => client.rawRequest<CreateKubernetesClusterMutation>(CreateKubernetesClusterDocumentString, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'CreateKubernetesCluster', 'mutation', variables);
    },
    CreateKubernetesGraph(variables: CreateKubernetesGraphMutationVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<{ data: CreateKubernetesGraphMutation; errors?: GraphQLError[]; extensions?: any; headers: Headers; status: number; }> {
        return withWrapper((wrappedRequestHeaders) => client.rawRequest<CreateKubernetesGraphMutation>(CreateKubernetesGraphDocumentString, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'CreateKubernetesGraph', 'mutation', variables);
    },
    DeleteGraph(variables: DeleteGraphMutationVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<{ data: DeleteGraphMutation; errors?: GraphQLError[]; extensions?: any; headers: Headers; status: number; }> {
        return withWrapper((wrappedRequestHeaders) => client.rawRequest<DeleteGraphMutation>(DeleteGraphDocumentString, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'DeleteGraph', 'mutation', variables);
    },
    DeleteKubernetesCluster(variables: DeleteKubernetesClusterMutationVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<{ data: DeleteKubernetesClusterMutation; errors?: GraphQLError[]; extensions?: any; headers: Headers; status: number; }> {
        return withWrapper((wrappedRequestHeaders) => client.rawRequest<DeleteKubernetesClusterMutation>(DeleteKubernetesClusterDocumentString, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'DeleteKubernetesCluster', 'mutation', variables);
    },
    DeleteKubernetesGraph(variables: DeleteKubernetesGraphMutationVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<{ data: DeleteKubernetesGraphMutation; errors?: GraphQLError[]; extensions?: any; headers: Headers; status: number; }> {
        return withWrapper((wrappedRequestHeaders) => client.rawRequest<DeleteKubernetesGraphMutation>(DeleteKubernetesGraphDocumentString, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'DeleteKubernetesGraph', 'mutation', variables);
    },
    UpdateGraph(variables: UpdateGraphMutationVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<{ data: UpdateGraphMutation; errors?: GraphQLError[]; extensions?: any; headers: Headers; status: number; }> {
        return withWrapper((wrappedRequestHeaders) => client.rawRequest<UpdateGraphMutation>(UpdateGraphDocumentString, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'UpdateGraph', 'mutation', variables);
    },
    UpdateKubernetesCluster(variables: UpdateKubernetesClusterMutationVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<{ data: UpdateKubernetesClusterMutation; errors?: GraphQLError[]; extensions?: any; headers: Headers; status: number; }> {
        return withWrapper((wrappedRequestHeaders) => client.rawRequest<UpdateKubernetesClusterMutation>(UpdateKubernetesClusterDocumentString, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'UpdateKubernetesCluster', 'mutation', variables);
    },
    UpdateKubernetesGraph(variables: UpdateKubernetesGraphMutationVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<{ data: UpdateKubernetesGraphMutation; errors?: GraphQLError[]; extensions?: any; headers: Headers; status: number; }> {
        return withWrapper((wrappedRequestHeaders) => client.rawRequest<UpdateKubernetesGraphMutation>(UpdateKubernetesGraphDocumentString, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'UpdateKubernetesGraph', 'mutation', variables);
    },
    DeployInfrastructure(variables: DeployInfrastructureMutationVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<{ data: DeployInfrastructureMutation; errors?: GraphQLError[]; extensions?: any; headers: Headers; status: number; }> {
        return withWrapper((wrappedRequestHeaders) => client.rawRequest<DeployInfrastructureMutation>(DeployInfrastructureDocumentString, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'DeployInfrastructure', 'mutation', variables);
    },
    InitializeCodeGen(variables: InitializeCodeGenMutationVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<{ data: InitializeCodeGenMutation; errors?: GraphQLError[]; extensions?: any; headers: Headers; status: number; }> {
        return withWrapper((wrappedRequestHeaders) => client.rawRequest<InitializeCodeGenMutation>(InitializeCodeGenDocumentString, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'InitializeCodeGen', 'mutation', variables);
    },
    ExternalDependency(variables: ExternalDependencyQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<{ data: ExternalDependencyQuery; errors?: GraphQLError[]; extensions?: any; headers: Headers; status: number; }> {
        return withWrapper((wrappedRequestHeaders) => client.rawRequest<ExternalDependencyQuery>(ExternalDependencyDocumentString, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'ExternalDependency', 'query', variables);
    },
    Graph(variables: GraphQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<{ data: GraphQuery; errors?: GraphQLError[]; extensions?: any; headers: Headers; status: number; }> {
        return withWrapper((wrappedRequestHeaders) => client.rawRequest<GraphQuery>(GraphDocumentString, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'Graph', 'query', variables);
    },
    GraphByName(variables: GraphByNameQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<{ data: GraphByNameQuery; errors?: GraphQLError[]; extensions?: any; headers: Headers; status: number; }> {
        return withWrapper((wrappedRequestHeaders) => client.rawRequest<GraphByNameQuery>(GraphByNameDocumentString, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'GraphByName', 'query', variables);
    },
    KubernetesCluster(variables: KubernetesClusterQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<{ data: KubernetesClusterQuery; errors?: GraphQLError[]; extensions?: any; headers: Headers; status: number; }> {
        return withWrapper((wrappedRequestHeaders) => client.rawRequest<KubernetesClusterQuery>(KubernetesClusterDocumentString, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'KubernetesCluster', 'query', variables);
    },
    KubernetesClusters(variables: KubernetesClustersQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<{ data: KubernetesClustersQuery; errors?: GraphQLError[]; extensions?: any; headers: Headers; status: number; }> {
        return withWrapper((wrappedRequestHeaders) => client.rawRequest<KubernetesClustersQuery>(KubernetesClustersDocumentString, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'KubernetesClusters', 'query', variables);
    },
    KubernetesGraph(variables: KubernetesGraphQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<{ data: KubernetesGraphQuery; errors?: GraphQLError[]; extensions?: any; headers: Headers; status: number; }> {
        return withWrapper((wrappedRequestHeaders) => client.rawRequest<KubernetesGraphQuery>(KubernetesGraphDocumentString, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'KubernetesGraph', 'query', variables);
    },
    KubernetesGraphs(variables: KubernetesGraphsQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<{ data: KubernetesGraphsQuery; errors?: GraphQLError[]; extensions?: any; headers: Headers; status: number; }> {
        return withWrapper((wrappedRequestHeaders) => client.rawRequest<KubernetesGraphsQuery>(KubernetesGraphsDocumentString, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'KubernetesGraphs', 'query', variables);
    },
    KubernetesResourcesByNamespace(variables: KubernetesResourcesByNamespaceQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<{ data: KubernetesResourcesByNamespaceQuery; errors?: GraphQLError[]; extensions?: any; headers: Headers; status: number; }> {
        return withWrapper((wrappedRequestHeaders) => client.rawRequest<KubernetesResourcesByNamespaceQuery>(KubernetesResourcesByNamespaceDocumentString, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'KubernetesResourcesByNamespace', 'query', variables);
    },
    KubernetesResourcesByType(variables: KubernetesResourcesByTypeQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<{ data: KubernetesResourcesByTypeQuery; errors?: GraphQLError[]; extensions?: any; headers: Headers; status: number; }> {
        return withWrapper((wrappedRequestHeaders) => client.rawRequest<KubernetesResourcesByTypeQuery>(KubernetesResourcesByTypeDocumentString, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'KubernetesResourcesByType', 'query', variables);
    },
    Node(variables: NodeQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<{ data: NodeQuery; errors?: GraphQLError[]; extensions?: any; headers: Headers; status: number; }> {
        return withWrapper((wrappedRequestHeaders) => client.rawRequest<NodeQuery>(NodeDocumentString, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'Node', 'query', variables);
    },
    JobStatus(variables: JobStatusQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<{ data: JobStatusQuery; errors?: GraphQLError[]; extensions?: any; headers: Headers; status: number; }> {
        return withWrapper((wrappedRequestHeaders) => client.rawRequest<JobStatusQuery>(JobStatusDocumentString, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'JobStatus', 'query', variables);
    },
    InitializePlan(variables: InitializePlanMutationVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<{ data: InitializePlanMutation; errors?: GraphQLError[]; extensions?: any; headers: Headers; status: number; }> {
        return withWrapper((wrappedRequestHeaders) => client.rawRequest<InitializePlanMutation>(InitializePlanDocumentString, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'InitializePlan', 'mutation', variables);
    },
    GetPlan(variables: GetPlanQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<{ data: GetPlanQuery; errors?: GraphQLError[]; extensions?: any; headers: Headers; status: number; }> {
        return withWrapper((wrappedRequestHeaders) => client.rawRequest<GetPlanQuery>(GetPlanDocumentString, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'GetPlan', 'query', variables);
    }
  };
}
