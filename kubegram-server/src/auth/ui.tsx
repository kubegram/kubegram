...
export const ProviderSelect: React.FC<ProviderSelectProps> = ({ providers, basePath, logoUrl }) => {
  const icons: Record<string, string> = {
    ...
    password: `<svg height="20" width="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="11" width="18" height="11" rx="2" ry="2"/><path d="M7 11V7a5 5 0 0 1 10 0v4"/></svg>`
  };
