...
Kubegram combines a visual design interface, AI-powered orchestration, and GitOps automation into a single platform for Kubernetes infrastructure management.
...
The agentic layer connects AI models directly to live Kubernetes infrastructure through a bi-directional MCP bridge.
...
- **Multi-Provider Support**: Connect Claude, OpenAI, Gemini, DeepSeek, and Ollama simultaneously

## Visual Design System

### Canvas Architecture

The visual designer translates user interactions into infrastructure intent through a layered pipeline:
...
- [Visual Designer Guide](../visual-designer/canvas-guide) — build your first infrastructure design on the canvas
- [AI Orchestration Concepts](../AI-orchestration/concepts) — how multi-provider AI routing works
